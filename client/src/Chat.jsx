    ...
    <>
        <div className="ChatroomHeader flex flex-row">
            ...
            {selectedChatroom.admin &&
                selectedChatroom.admin === user._id && ( // Ensure comparison is correct
                    <>
                        <button className="AddUserButton m-2 p-2 bg-teal-400 rounded-lg">
                            <svg
                        ...
                        <button className="DeleteChatButton m-2 p-2 bg-red-400 rounded-lg">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                                viewBox="0 0 24 24"
